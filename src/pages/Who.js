...
import MyResume from "../Files/Di Sorbo Florencia-CV.pdf"
        ...
        <div>
            <div>
                ...
                <div className="title">   
                    ...
                    <br></br>
                    a self-taught  
                    <span className="word"> UX Designer , </span> with passion for 
            ...
            <div className="main">
              {/*  <img className="profileImg" src="../images/perfilflor.png" alt="imagen"></img> */}
                ...
                <p  className="mainText">🧐 All things Product and Service Design marvel me, so I am diving in. </p>
                <p className="mainText">😍 I completed the <a className="link" href="https://www.credly.com/badges/a279e2b7-7705-44b5-95bb-1514cb5b4fce/public_url" target="_blank" rel="noreferrer" >UX Design Professional Certificate  </a>by Google.</p>
                <p  className="mainText">🔧 I am continously improving my front-end coding skills on HTML / CSS / JavaScript / React JS * . </p>
